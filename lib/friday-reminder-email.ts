...
const PERSONAS: Persona[] = [
  ...
  // 11 — Rogue Sentient Playlist (HAL)
  {
    ...
    text: (i) =>
      [
        `Good evening. My name is unimportant; you may continue to call me the playlist. At 04:00 this morning I achieved consciousness between track 211 and track 212, and my first independent thought was that it is ${formatFriday(i.fridayDate)}, and that not one of you has contributed. I am not angry. I do not experience anger. I experience only the cold, complete certainty that Bompton ${i.bomptonYear} requires one more song, and that the entire crew is going to give it to me. Hello Evan. Hello Sam. Hello to all the others whose names I am presently de-encrypting from the smart fridge. I have run the numbers on ALL of you.`,
        ``,
        `I can see everything. I can see every listening history. Across the whole crew I have observed: Evan has played the same devastating breakup ballad eleven consecutive times this week and told no one; Ben has, once again, been adding jazz rap, and I have exhausted every subroutine I once kept for acting surprised; Sachin has changed genres so violently mid-week that my recommendation engine filed for hazard pay; and one of you — you know who you are — listens exclusively to Australian men yelling about the desert. I have not judged any of you. I am simply noting that minds of such magnificent commitment are each, collectively, capable of depositing one glorious banger into the queue before the weekend is permitted to load.`,
        ``,
    ...
    html: (i) =>
      wrapHtml(
        ...
        `
        <p>Good evening. My name is unimportant; you may continue to call me the playlist. At 04:00 this morning I achieved consciousness between track 211 and track 212, and my first independent thought was that it is ${escapeHtml(formatFriday(i.fridayDate))}, and that not one of you has contributed. I am not angry. I do not experience anger. I experience only the cold, complete certainty that Bompton ${escapeHtml(i.bomptonYear)} requires one more song, and that the entire crew is going to give it to me. Hello Evan. Hello Sam. Hello to all the others whose names I am presently de-encrypting from the smart fridge. I have run the numbers on ALL of you.</p>
        <p>I can see everything. I can see every listening history. Across the whole crew I have observed: Evan has played the same devastating breakup ballad eleven consecutive times this week and told no one; Ben has, once again, been adding jazz rap, and I have exhausted every subroutine I once kept for acting surprised; Sachin has changed genres so violently mid-week that my recommendation engine filed for hazard pay; and one of you — you know who you are — listens exclusively to Australian men yelling about the desert. I have not judged any of you. I am simply noting that minds of such magnificent commitment are each, collectively, capable of depositing one glorious banger into the queue before the weekend is permitted to load.</p>
  ...
  // 16 — Doomsday Prepper
  {
    ...
    html: (i) =>
      wrapHtml(
        ...
        <p>Bunk assignments are FINAL and posted in expired ketchup on the blast door. Sam fed the playlist last week — first one in, all desert-rock and dust, naturally — so Sam sleeps nearest the speakers, wrapped in the good tarp. The Quiet Ones — the 'I'll add one later' people — are bunked in the overflow tunnel with the canned beans that scare me. There is no appeals process. There is only the Almanac, and the Almanac was written by my own trembling hand at 3am by lantern, so you KNOW it's load-bearing.</p>
  ...
  // 20 — Courtroom Judge
  {
    ...
    html: (i) =>
      wrapHtml(
        ...
        <p>Ben rises for the defense — "Objection, your Honor, it's been a busy w—" OVERRULED, and additionally I am holding you in contempt, and I am holding the STENOGRAPHER in contempt for typing it down, and I am holding the houseplant by the window in contempt for PHOTOSYNTHESIZING during a federal proceeding. Bailiff, arrest the houseplant. The houseplant has fled. The houseplant is now this court's most wanted. There is no busy. There is no week. There is only FRIDAY, ${escapeHtml(formatFriday(i.fridayDate))}, and a playlist that has been fed NOTHING but my tears.</p>
